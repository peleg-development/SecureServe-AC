...
client_scripts {
    ...
    "src/client/protections/anti_esp.lua",
    "src/client/protections/anti_input_block.lua",
    "src/client/blacklists/blacklisted_commands.lua",
    "src/client/blacklists/blacklisted_weapons.lua",
    "src/client/blacklists/blacklisted_sprites.lua",
    "src/client/main.lua",
...
server_scripts {
    ...
    "src/server/protections/anti_unknown_event.lua",
