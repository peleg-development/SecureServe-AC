    ...
    Citizen.CreateThread(function()
        while true do
            ...
            local in_anim = IsEntityPlayingAnim(ped, "anim@heists@", "", 3)
                or IsEntityPlayingAnim(ped, "anim@safe@", "", 3)
                or IsEntityPlayingAnim(ped, "anim@gangops@", "", 3)
                or IsEntityPlayingAnim(ped, "amb@", "", 3)
                or IsEntityPlayingAnim(ped, "mp_arresting", "", 3)
                or IsEntityPlayingAnim(ped, "missheist", "", 3)
