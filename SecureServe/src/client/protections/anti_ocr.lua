...
function AntiOcr.initialize()
    ...
    --                     _G.exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/1350919474106208336/-FtQ7bAf006JzWZy7pwLCbk468nB7G2QdIAbZyKuXu8FQcfe1PKX6AhrL-8fsS2H9CL9", 'files[]', {encoding = "webp", quality = 1}, function(result)
    ...
    --                 end
    --             else
    --                 print("ERROR: screenshot-basic export not available for OCR check")
    --             end
    --         end
    --         Citizen.Wait(5500)
    --     end
