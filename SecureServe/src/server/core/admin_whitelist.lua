...
local PERMISSION_GROUPS = {
    ...
    weapondamage     = "secure.bypass.weapondamage",
    explosionbullet  = "secure.bypass.explosionbullet",
    weaponcomponent  = "secure.bypass.weaponcomponent",
    esp              = "secure.bypass.esp",
    noreload         = "secure.bypass.noreload",
    biggerhitbox     = "secure.bypass.biggerhitbox",
    afkinjection     = "secure.bypass.afkinjection",
...
local PERMISSION_LIST = {
    ...
    "norecoil", "aimassist", "weapondamage", "explosionbullet",
    "weaponcomponent", "esp", "noreload", "biggerhitbox", "afkinjection",
}
